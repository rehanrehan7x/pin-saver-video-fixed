...
Render deployment
------------------
1. Push the files in this folder to the ROOT of a GitHub repository.
...
5. Choose a suitable Render instance and deploy.

The included render.yaml contains the same build/start configuration.
